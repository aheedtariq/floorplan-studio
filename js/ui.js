...
(function (root) {
  ...
  const RAIL = [
    ...
    { id: 'arrow', tool: 'line', kind: 'arrow', key: 'R', name: 'Arrow',
      icon: '<path d="M4 20 20 4m0 0h-7m7 0v7"/>' },
    { id: 'marker', tool: 'poly', kind: 'marker', key: 'K', name: 'Marker highlight — click corners, Enter to finish',
      icon: '<path d="m4 16 9-9 4 4-9 9H4z"/><path d="m13 7 3-3 4 4-3 3"/>' },
    { id: 'note', tool: 'draw', kind: 'note', key: 'N', name: 'Sticky note',
      icon: '<path d="M4 4h16v10l-6 6H4z"/><path d="M14 20v-6h6"/>' },
