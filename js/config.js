...
(function (root) {
  ...
  const kindDefs = [
    ...
    { id: 'table-round-60', name: 'Round table 60"', cat: 'rentals', layer: 'contents', shape: 'rect',
      ...
      fill: '#d6d3d1', stroke: '#78716c', opacity: .55, icon: ic.table, fields: [F.label, F.throw_] },
    { id: 'cocktail-table', name: 'Networking table 30"', cat: 'rentals', layer: 'contents', shape: 'rect',
    ...
    { id: 'turf', name: 'Turf / artificial grass', cat: 'rentals', layer: 'zones', shape: 'rect',
      ...
      fields: [
        ...
        F.label] },
    { id: 'charging-station', name: 'Charging station', cat: 'rentals', layer: 'contents', shape: 'rect',
