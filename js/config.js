...
(function (root) {
  ...
  const kindDefs = [
    ...
    { id: 'table-round-60', name: 'Round table 60"', cat: 'rentals', layer: 'contents', shape: 'rect',
      scope: ['hall', 'booth'], size: [5, 5], symbol: 'table',
      fill: '#d6d3d1', stroke: '#78716c', opacity: .55, icon: ic.table, fields: [F.label, F.throw_] },
    { id: 'cocktail-table', name: 'Cocktail table 30"', cat: 'rentals', layer: 'contents', shape: 'rect',
    ...
    { id: 'lounge-chair', name: 'Lounge chair', cat: 'rentals', layer: 'contents', shape: 'rect',
    ...
    { id: 'carpet', name: 'Carpet / flooring', cat: 'rentals', layer: 'zones', shape: 'rect',
      scope: ['hall', 'booth'], size: [10, 10],
      fill: '#9ca3af', stroke: '#6b7280', opacity: .22, icon: ic.carpet,
